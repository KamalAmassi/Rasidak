          ...
          Obx(() => GestureDetector(
            onTap: () {
              showModalBottomSheet(
                ...
                builder: (_) => buildCustomerPicker(customerController, debtController),
              );
            },
            child: Container(
    ...
    Widget buildBoxField() {
      InputDecoration fieldDecoration({required String hint, Widget? prefix}) {
        return InputDecoration(
          hintText: hint,
          hintStyle: TextStyle(color: AppColors.primaryText, fontSize: hintFontSize),
          filled: true,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                style: TextStyle(fontSize: inputFontSize,color: AppColors.primaryText),
